...
For validation of this method to several kinds of molecular data and environments, please see Pascoal et al., 2024 (in peer-review).
...
lies between 3 and 10 (see Pascoal et al., 2024 for reasoning behind this). In `vignette("explore-classifications")`,
...
- Pascoal F., Branco P., Torgo., Costa R., Magalhães C., 2024. Definition of the microbial rare biosphere through unsupervised machine learning. Communications Biology, in peer-review.
