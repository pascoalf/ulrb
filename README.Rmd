...
![GitHub all releases](https://img.shields.io/github/downloads/pascoalf/ulrb/total)
...
or "abundant". In alternative, we provide functions to help the user decide the number
of clusters and we also provide a fully automated option. Besides clustering, we have 
